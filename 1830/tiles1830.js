...
// for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'A8', Owner:'GAME', Connections:['edge3-bC-edge5'], no:num, Color:'yellow', Upgrades:'B35,B36,B37', Value:0, Rotated:0})};
// for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'A9', Owner:'GAME', Connections:['edge3-bC-edge4'], no:num, Color:'yellow', Upgrades:'B35,B36,B37', Value:0, Rotated:0})};
...
for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'bb1', Owner:'GAME', Connections:['edge1-bC-edge3', 'edge3-bC-edge5',  'edge1-bC-edge5'], no:num, Color:'green', Upgrades:'bb5,bb6,bb7', Value:20, Rotated:0})};
// for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'bb2', Owner:'GAME', Connections:['edge1-bC-bC-edge3', 'edge3-bC-bC-edge5',  'edge1-bC-bC-edge5'], no:num, Color:'green', Upgrades:'bb5,bb6,bb7', Value:20, Rotated:0})};
// for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'bb5', Owner:'GAME', Connections:['edge0-bC-edge1', 'edge0-bC-edge5',  'edge1-bC-edge5',  'edge0-bC-edge3',  'edge1-bC-edge3',  'edge5-bC-edge3'], no:num, Color:'brown', Upgrades:'', Value:20, Rotated:0})};
// for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'bb6', Owner:'GAME', Connections:['edge0-bC-bC-bC-edge1', 'edge0-bC-bC-bC-edge5',  'edge1-bC-bC-bC-edge5',  'edge0-bC-bC-bC-edge3',  'edge1-bC-bC-bC-edge3',  'edge5-bC-bC-bC-edge3'], no:num, Color:'brown', Upgrades:'', Value:20, Rotated:0})};
// for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'bb7', Owner:'GAME', Connections:['edge0-bC-bC-edge1', 'edge0-bC-bC-edge5',  'edge1-bC-bC-edge5',  'edge0-bC-bC-edge3',  'edge1-bC-bC-edge3',  'edge5-bC-bC-edge3'], no:num, Color:'brown', Upgrades:'', Value:20, Rotated:0})};
// for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'to1', Owner:'GAME', Connections:['edge0-bC-edge1', 'edge0-bC-edge5',  'edge1-bC-edge5',  'edge3-bC-edge4',  'edge2-bC-edge3',  'edge2-bC-edge4'], no:num, Color:'brown', Upgrades:'', DesignatedHex:'D10', Value:20, Rotated:0})};
...
for (let num=0;num<3;num++) {tiles_1830.addTrackTile({Id:'B35', Owner:'GAME', Connections:['edge0-bC-bC-edge3', 'edge2-bC-bC-edge5','edge0-bC-bC-edge5','edge3-bC-bC-edge2','edge3-bC-bC-edge5','edge0-bC-bC-edge2'], no:num, Color:'green', Upgrades:'C15', Value:10, Rotated:0})};
// for (let num=0;num<4;num++) {tiles_1830.addTrackTile({Id:'B36', Owner:'GAME', Connections:['edge0-bC-bC-edge3', 'edge2-bC-bC-edge5','edge0-bC-bC-edge5','edge3-bC-bC-edge2','edge3-bC-bC-edge5','edge0-bC-bC-edge2'], no:num, Color:'green', Upgrades:'C15', Value:10, Rotated:0})};
// for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'B36', Owner:'GAME', Connections:['edge3-bC-bC-edge5', 'edge1-bC-bC-edge2','edge1-bC-bC-edge3','edge2-bC-bC-edge5','edge1-bC-bC-edge5','edge2-bC-bC-edge3'], no:num, Color:'green', Upgrades:'C15', Value:10, Rotated:0})};
for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'B37', Owner:'GAME', Connections:['edge0-bC-bC-edge1', 'edge1-bC-bC-edge2','edge2-bC-bC-edge3','edge0-bC-bC-edge2','edge1-bC-bC-edge3','edge0-bC-bC-edge3'], no:num, Color:'green', Upgrades:'C15', Value:10, Rotated:0})};
// for (let num=0;num<4;num++) {tiles_1830.addTrackTile({Id:'B37', Owner:'GAME', Connections:['edge0-bC-bC-edge1', 'edge1-bC-bC-edge2','edge2-bC-bC-edge3','edge0-bC-bC-edge2','edge1-bC-bC-edge3','edge0-bC-bC-edge3'], no:num, Color:'green', Upgrades:'C15', Value:10, Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'ny1', Owner:'GAME', Connections:['edge0-bC1-edge5', 'edge1-bC2-edge2'], no:num, Color:'green', Upgrades:'ny5,ny6', Value:10, DesignatedHex:'G19', Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'ny5', Owner:'GAME', Connections:['edge0-bC1-bC1-edge5', 'edge2-bC2-bC2-edge3'], no:num, Color:'brown', Upgrades:'', Value:10, DesignatedHex:'G19', Rotated:0})};
// for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'ny6', Owner:'GAME', Connections:['edge0-bC-bC-edge5', 'edge2-bC-bC-edge3'], no:num, Color:'brown', Upgrades:'', Value:10, DesignatedHex:'G19', Rotated:0})};
...
for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'C15', Owner:'GAME', Connections:['edge0-bC-bC-edge3', 'edge2-bC-bC-edge5','edge1-bC-bC-edge4','edge0-bC-bC-edge1','edge1-bC-bC-edge2','edge2-bC-bC-edge3', 'edge3-bC-bC-edge4', 'edge4-bC-bC-edge5', 'edge5-bC-bC-edge0','edge0-bC-bC-edge2','edge2-bC-bC-edge4', 'edge4-bC-bC-edge0'], no:num, Color:'brown', Upgrades:'D4', Value:20, Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo1', Owner:'GAME', Connections:['edge1-bC1-edge2', 'edge4-bC2-edge5'], no:num, Color:'green', Upgrades:'oo10,oo11,oo12,oo13,oo14,oo15,oo16,oo17', Value:10, DesignatedHex:'H18', Rotated:0})};
for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'oo2', Owner:'GAME', Connections:['edge2-bC1', 'edge4-bC2'], no:num, Color:'green', Upgrades:'oo10,oo11,oo12,oo13,oo14,oo15,oo16,oo17', Value:10, DesignatedHex:'H18', Rotated:0})};
// for (let num=0;num<3;num++) {tiles_1830.addTrackTile({Id:'oo2', Owner:'GAME', Connections:['edge2-bC1', 'edge4-bC2'], no:num, Color:'green', Upgrades:'oo10,oo11,oo12,oo13,oo14,oo15,oo16,oo17', Value:10, DesignatedHex:'H18', Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo10', Owner:'GAME', Connections:['edge0-bC1-edge3', 'edge1-bC2-edge4'], no:num, Color:'brown', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo11', Owner:'GAME', Connections:['edge0-bC1-edge3', 'edge0-bC2-edge5','edge0-edge1'], no:num, Color:'brown', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo12', Owner:'GAME', Connections:['edge0-bC1-edge3', 'edge1-bC2-edge2'], no:num, Color:'brown', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo13', Owner:'GAME', Connections:['edge0-bC1-edge2', 'edge3-bC2-edge5'], no:num, Color:'brown', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo14', Owner:'GAME', Connections:['edge3-bC1-edge5', 'edge2-bC2-edge4'], no:num, Color:'brown', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo15', Owner:'GAME', Connections:['edge3-bC1-edge5', 'edge1-bC2-edge2'], no:num, Color:'brown', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo16', Owner:'GAME', Connections:['edge0-bC1-edge1', 'edge3-bC2-edge5'], no:num, Color:'brown', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
// for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo17', Owner:'GAME', Connections:['edge0-bC1-edge5', 'edge1-bC2-edge2'], no:num, Color:'brown', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
// for (let num=0;num<1;num++) {tiles_1830.addTrackTile({Id:'oo20', Owner:'GAME', Connections:['edge3-bC1', 'edge4-bC2','edge0-bC1-edge5','edge1-bC2-edge2','edge1-bC2-edge4','edge2-bC2-edge4','edge0-bC1-edge3','edge5-bC1-edge3'], no:num, Color:'grey', Upgrades:'oo20', Value:10, DesignatedHex:'H18', Rotated:0})};
// for (let num=0;num<2;num++) {tiles_1830.addTrackTile({Id:'D4', Owner:'GAME', Connections:['edge0-bC-bC-bC-edge3', 'edge2-bC-bC-bC-edge5','edge1-bC-bC-bC-edge4','edge0-bC-bC-bC-edge1','edge1-bC-bC-bC-edge2','edge2-bC-bC-bC-edge3', 'edge3-bC-bC-bC-edge4', 'edge4-bC-bC-bC-edge5', 'edge5-bC-bC-bC-edge0','edge0-bC-bC-bC-edge2','edge2-bC-bC-bC-edge4', 'edge4-bC-bC-bC-edge0'], no:num, Color:'grey', Upgrades:'', Value:20, Rotated:0})};
