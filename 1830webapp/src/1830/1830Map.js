...
class MapHex extends MapH  {
     ...
     */
    addTile (o) {
        // o.Id = o.Id || ''; // the Id of the Map HEX
        // o.Pos = o.Pos || ''; // the axial coordinates position of the hex on the map
        // o.Color = o.Color || ''; // the color of the map hex
        // o.Revenue = o.Revenue || ''; // the revenue generated by the hex. Can have 2 or more values, comma delimited
        // o.Connections = o.Connections || []; // where the connections are if this is the case. Red hexes are blocked for placement
        // o.Blocked = o.Blocked || []; // Blocked edges, no routes can pass through these edges
        // o.Cost = o.Cost || ''; // cost to build on this hex
        // o.Cities = o.Cities || ''; // list of cities on the hex sC = small City, bc=big City, #edge = near the edge, = name of the city
        // o.Split = o.Split || ''; // how the hex is split
        this.Map1830.push(o);
    };
